//function olamundo() {
 ...
 document.getElementById("resultado").innerHTML = "Seu " + marca + " " + modelo + " fez " + consumo + "KM/L" ;
var paragraph2 = document.getElementById("paragraph2");
 ...
 var paragraph4 = document.getElementById("paragraph4");
  ...
  paragraph2.style.backgroundColor = "orange";
  }
  
  else if( consumo >= 8 && consumo < 12){
  paragraph3.style.backgroundColor = "orange";
  }
